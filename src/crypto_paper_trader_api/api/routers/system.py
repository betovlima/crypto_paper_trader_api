...
def public_configuration() -> PublicConfiguration:
    return PublicConfiguration(
        ...
        adaptive_research_transition_retry_minutes=settings.adaptive_research_transition_retry_minutes,
        ...
        adaptive_research_hard_min_trades=settings.adaptive_research_hard_min_trades,
        ...
        adaptive_research_champion_min_improvement=settings.adaptive_research_champion_min_improvement,
    )
