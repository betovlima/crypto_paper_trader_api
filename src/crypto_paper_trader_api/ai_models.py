...
class AIHistorySyncState(AIBase):
    ...
    candles_added_last_attempt: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    empty_windows_last_attempt: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
